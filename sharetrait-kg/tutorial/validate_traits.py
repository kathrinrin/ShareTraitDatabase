"""Validate sharetrait-traits.ttl — run with: python sharetrait-kg/tutorial/validate_traits.py"""
from pathlib import Path

from rdflib import Graph, OWL, RDF, RDFS, URIRef, Namespace
from rdflib.collection import Collection

# Resolve paths relative to this script's location (sharetrait-kg/tutorial/)
